%
% Analyze Data: Variable - Current Density
%
clear all;
%
...
%
flag.do_spec      = 0;      % AP spectroram
flag.do_spec_fig1 = 1;      % display spectrums in 1 figure
flag.do_spec_fig  = 1;      % display figures
flag.do_spec_fint = 9;      % display-spec-fig interval
flag.do_spec_save = 0;      % save result to file
%
flag.do_fit       = 0;      % AP spectrogram fitting
...
param.aptrim    = [5 3];    % [5 3] to narrow window and shift peak 
param.noise     = 0;        % mV (***use INTEGER ONLY***)
param.fitrange1 = [1  7];   % 2  6
param.fitrange2 = [6 20];   % 6 20
param.fitrange3 = [20 0];   % zero means to end of vector
%
analyzeaps( 'Current', 'cur', param, flag );
