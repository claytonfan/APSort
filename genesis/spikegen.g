...
include markovchanspike		// functions to create stochastic channels
...
*/
str outfile  = "smControl.dat"    // Output file name 
...
float tmax = 6.5535		// simulation time in sec -- orig 0.1
float dt = 0.0001		// simulation time step in sec -- orig 0.00005
setclock  0  {dt}		// set the simulation clock
setclock  1  {10*dt}		// graphics clock

float Idens = 0.03 // default injection current density in A/m^2  // 0.03
...
disable /library
pushe /library
make_Na_squid_markovspike
make_K_squid_markovspike
make_markovspike_compt
pope
...
setfield /cell/soma/spike  thresh .1  abs_refract 0.010  output_amp 1
/* use the soma membrane potential to drive the spike generator */
addmsg  /cell/soma  /cell/soma/spike  INPUT Vm

// Setup output files
create asc_file /out
setfield /out   filename {outfile}   flush 1  leave_open 1  // Do NOT append 1
useclock /out 0
